...
static void wpa_supplicant_scan(void *eloop_ctx, void *timeout_ctx)
{
	...
	os_null_printf("wpa_supplicant_scan\r\n");
...
void wpa_supplicant_req_scan(struct wpa_supplicant *wpa_s, int sec, int usec)
{
	...
	os_null_printf("wpa_supplicant_req_scan\r\n");
	...
	{
		os_printf("Ignore new scan request for %d.%06d sec\r\n",
					sec, usec);
	} 
	else 
	{
...
{
	os_null_printf("Cancelling scan request\r\n");
