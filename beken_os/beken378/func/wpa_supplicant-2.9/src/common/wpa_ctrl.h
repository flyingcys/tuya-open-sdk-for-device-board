...
typedef enum wpa_ctrl_cmd {
	/* STA */
	/* If enable multiple networks support  */
	WPA_CTRL_CMD_ADD_NETWORK			 = 0,
	WPA_CTRL_CMD_REMOVE_NETWORK,
	WPA_CTRL_CMD_SELECT_NETWORK,
	WPA_CTRL_CMD_STA_SCAN,
	WPA_CTRL_CMD_STA_SCAN_RESULTS,
	WPA_CTRL_CMD_STA_SCAN_INTERVAL,

//	WPA_CTRL_CMD_STA_CONNECT,
...
//	WPA_CTRL_CMD_STA_BSS_EXPIRE_COUNT,
	WPA_CTRL_CMD_STA_BSS_MAX_COUNT,
	WPA_CTRL_CMD_STA_BSS_FLUSH,
	WPA_CTRL_CMD_STA_BSS_SIZE_GET,
	WPA_CTRL_CMD_STA_BSS_GET,
	WPA_CTRL_CMD_STA_BSS_SET,

	WPA_CTRL_CMD_STA_GEN_PSK,

	WPA_CTRL_CMD_STA_WPS_PBC             = 50,
	WPA_CTRL_CMD_STA_WPS_GET_PIN,
	WPA_CTRL_CMD_STA_WPS_SET_PIN,

	/* softAP */
	WPA_CTRL_CMD_AP_ENABLE               = 100,
...
//	WPA_CTRL_CMD_AP_TERMINATE,
	...
	/* MISC */
	WPA_CTLR_CMD_ADD_NOTIFIER,
	WPA_CTLR_CMD_REMOVE_NOTIFIER,

	WPA_CTRL_CMD_SOCKET					 = 200,
	WPA_CTRL_CMD_RW_EVT_START 			 = WPA_CTRL_CMD_SOCKET + 1,
	WPA_CTRL_EVENT_AUTH_IND,
	WPA_CTRL_EVENT_EXTERNAL_AUTH_IND,
	WPA_CTRL_EVENT_ASSOC_IND,
	WPA_CTRL_EVENT_CONNECT_IND,
	WPA_CTRL_EVENT_DISCONNECT_IND,
	WPA_CTRL_EVENT_CHAN_SWITCH_IND,
	WPA_CTRL_EVENT_MGMT_IND,
} wpa_ctrl_cmd_t;
