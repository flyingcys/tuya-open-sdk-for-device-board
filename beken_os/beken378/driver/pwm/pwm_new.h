...
extern void pwm_group_update_param_enable(UINT8 channel1,UINT8 channel2,pwm_param_t *pwm_param);
extern void pwm_nogroup_update_param_enable(UINT8 channel1,UINT8 channel2,pwm_param_t *pwm_param);
