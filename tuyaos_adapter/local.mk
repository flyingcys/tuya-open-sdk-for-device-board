...
# LOCAL_TUYA_SDK_CFLAGS := $(addprefix -I, $(shell find $(LOCAL_PATH)/include -type d))
...
# 模块内部CFLAGS：仅供本组件使用
LOCAL_CFLAGS := $(addprefix -I, $(shell find $(LOCAL_PATH) -type d)) 
LOCAL_CFLAGS += $(addprefix -I, $(shell find $(LOCAL_PATH)/include -type d))
